...
if [ $number -eq 1 ]
    ...
    then 
        echo "Bạn muốn xem nội dung thư mục của của foler: `read path1`"
        echo "Đây là nội dung thư mục $path: ls -l"
elif [ $number -eq 3 ]
    then
        echo "Nhập tên file bạn muốn xem: `read file1`"
        echo "Đây là nội dung file $file1:"
        cat $file1
elif [ $number -eq 4 ]
    then 
        echo "Nhập tên file hoặc thư mục bạn muốn xóa: `read folder1`"
        rm -rf $folder1
        if [ echo $? -eq 0 ]
            then
                echo "Xóa thành công"
    ...
    then
        echo "Nhập đường dẫn bạn muốn chuyển đến: `read path2`"
        cd $path2
elif [ $number -eq 6 ]
    then 
        echo "Nhập tên thư mục bạn muốn tạo: `read folder2`"
        mkdir $folder2
elif [ $number -eq 7 ]
    then
        echo "Nhập tên file bạn muốn tạo: `read file1`"
        touch $file1
elif [ $number -eq 8 ]
    then 
        echo "Nhập tên file hoặc folder bạn muốn tìm kiếm: `read all1`"
        locate -i $all1
elif [ $number -eq 9 ]
    then 
        ...
        echo "BẠN MUỐN XEM THÔNG TIN PHẦN CỨNG NÀO: `read num1`"
        if [ $num1 -eq 1 ]
            then
